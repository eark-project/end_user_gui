namespace end_user_gui.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Archivist_UniqueId = c.String(maxLength: 128),
                        User_UniqueId = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.OrderUniqueID)
                .ForeignKey("dbo.Archivists", t => t.Archivist_UniqueId)
                .ForeignKey("dbo.EndUsers", t => t.User_UniqueId)
                .Index(t => t.Archivist_UniqueId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "Archivist_UniqueId", "dbo.Archivists");
            ...
            DropIndex("dbo.Orders", new[] { "Archivist_UniqueId" });
            DropTable("dbo.OrderArchiveReferences");
            DropTable("dbo.Orders");
            DropTable("dbo.EndUsers");
            DropTable("dbo.Archivists");
        }
    }
}
